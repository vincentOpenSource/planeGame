...
var makeTitle = function (score) {
  if (score < 1000) {
    return "猪猪大战，还挺难的，我才" + score + "分，你能得多少分呢？";
  } else {
    return "猪猪大战，我是天才，得了" + score + "分，你能得多少分呢？";
  }
}
...
game.States.preload = function () {
  this.preload = function () {
    ...
    game.load.image('copyright', 'assets/label.png');
    game.load.spritesheet('myplane', 'assets/mypig.png', 26, 40, 4);
    ...
    game.load.spritesheet('enemy2', 'assets/enemy2.png', 29, 30, 4);
    ...
    game.load.audio('crash2', 'assets/pia.mp3');
    game.load.audio('crash3', 'assets/pengpa.mp3');
    game.load.audio('ao', 'assets/ao.mp3');
    game.load.audio('pi', 'assets/pia.mp3');
    game.load.audio('deng', 'assets/diu.mp3');
  };
  this.create = function () {
...
game.States.main = function () {
  this.create = function () {
    ...
    // 版权
    this.copyright = game.add.image(12, game.height - 33, 'copyright');
    // 我的飞机
...
game.States.start = function () {
  ...
  this.onStart = function () {
    ...
    this.text = game.add.text(0, 0, "分数: 0", style);
    score = 0;
    // 敌机
    var enemyTeam = {
      enemy1: {
  ...
  this.myFireBullet = function () {
    if (this.myplane.alive && game.time.now > this.bulletTime) {
      ...
      if (bullet) {
        bullet.reset(this.myplane.x + 9, this.myplane.y - 15);
...
game.States.over = function () {
  this.create = function () {
    ...
    this.text = game.add.text(0, 0, "分数: " + score, style);
  ...
  this.paintedEggshell = function () {
    document.title = `恭喜小猪打到了${score}分，触发彩蛋`;
    document.getElementById('share').style.display = 'block';
  }
}
